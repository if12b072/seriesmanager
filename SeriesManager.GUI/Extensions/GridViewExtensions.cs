...
namespace SeriesManager.GUI.Extensions
{
    /// <remarks>
    ...
    public class GridViewBindableSelectionHandler
    {
        ...
        private void Attach(GridView gridView, dynamic boundSelection)
        {
            ...
            if (_gridView.SelectionMode != ListViewSelectionMode.None)            
            ...
            var eventInfo = _boundSelection.GetType().GetDeclaredEvent("CollectionChanged");
